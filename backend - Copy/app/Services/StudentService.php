...
class StudentService
{
    ...
    {
        // For technical_skills and other_skills JSON columns
        $technical = Student::all()->pluck('technical_skills')->flatten()->unique()->values()->toArray();
        $other = Student::all()->pluck('other_skills')->flatten()->unique()->values()->toArray();
